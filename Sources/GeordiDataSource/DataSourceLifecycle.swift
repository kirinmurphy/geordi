...
public struct UserDataStore: Sendable {
  ...
  public func loadSnapshot(fileManager: FileManager = .default) throws -> GraphSnapshot? {
    ...
    do {
      ...
      throw UserDataStoreError.invalidSnapshot(String(describing: error))
    }
  }
  ...
  public func exportBackup(
    ...
    guard fileManager.fileExists(atPath: snapshotURL.path) else {
      throw UserDataStoreError.noCompiledData
    }
    guard destination.standardizedFileURL != root else {
      throw UserDataStoreError.unsafeDestination
    }
  ...
  public func reset(fileManager: FileManager = .default) throws {
    ...
    guard
      ...
      throw UserDataStoreError.unsafeRoot
    }
...
public enum UserDataStoreError: Error, Equatable, Sendable {
  case noCompiledData
...
extension UserDataStoreError: LocalizedError {
